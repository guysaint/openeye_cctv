...
def parse_args():
    ...
    p.add_argument("--video", type=str, default="../img/chair_test_480p_30fps.mp4",
                   help="영상 경로 또는 0(웹캠). 기본: ../img/chair_test_480p_30fps.mp4")
    p.add_argument("--template", type=str, default="/img/chair_template.png",
                   help="템플릿 이미지 경로 (의자 ROI). 기본: /img/chair_template.png")
