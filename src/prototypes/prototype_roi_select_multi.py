...
# -*- coding: utf-8 -*-
"""
Multi-ROI Template Capturer
- Freeze a frame, choose MULTIPLE ROIs at once, and auto-save them as:
  template_img1.jpg, template_img2.jpg, ...

Keys
  m : freeze current frame and open multi-ROI selector
  r : resume live preview (if frozen)
  q/ESC : quit

Config
  - SOURCE: camera index or video path
  - OUTPUT_DIR: folder to save crops
  - PREFIX: filename prefix (e.g., 'template_img')
  - START_IDX: starting number; if None, auto-continues from existing files
"""
