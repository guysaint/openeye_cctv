...
# name에 이름을 각자 환경에 맞도록 변경.
# 객체를 2개 이상 사용할 경우 딕셔너리에 아래 양식에 맞게 추가.
OBJECTS: List[Dict[str, Any]] = [
    {"name": "obj1",     "template_path": "../../assets/utemplate_img1.jpg",    "color": (0, 255, 0)},
    {"name": "obj2", "template_path": "../../assets/template_img2.jpg", "color": (255, 128, 0)},
]
